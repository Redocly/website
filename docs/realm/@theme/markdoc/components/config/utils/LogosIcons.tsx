...
function RealmLogo({ size = 16, title }: { size?: number; title?: string }): React.ReactElement {
  ...
  return (
    <svg
      ...
      role="img"
      aria-label={title || 'Realm'}
    >
      {title ? <title>{title}</title> : null}
      <path
        d="M6.25443 2.56438C6.48606 2.33275 6.8616 2.33275 7.09323 2.56438L12.4405 7.91169C12.6722 8.14332 12.6722 8.51886 12.4405 8.75048L7.09323 14.0978C6.8616 14.3294 6.48606 14.3294 6.25443 14.0978L0.907118 8.75048C0.675492 8.51886 0.675492 8.14332 0.907118 7.91169L6.25443 2.56438Z"
        fill={`url(#${gradA})`}
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M9.4826 2.57595C9.39628 2.48963 9.25632 2.48963 9.17 2.57595L4.23428 7.51167C4.14796 7.59799 4.14796 7.73795 4.23428 7.82427L9.17 12.76C9.25632 12.8463 9.39628 12.8463 9.4826 12.76L14.4183 7.82427C14.5046 7.73795 14.5046 7.59799 14.4183 7.51167L9.4826 2.57595ZM9.7457 1.90126C9.51407 1.66963 9.13853 1.66963 8.9069 1.90126L3.55959 7.24857C3.32796 7.4802 3.32796 7.85574 3.55959 8.08737L8.9069 13.4347C9.13853 13.6663 9.51407 13.6663 9.7457 13.4347L15.093 8.08737C15.3246 7.85574 15.3246 7.4802 15.093 7.24857L9.7457 1.90126Z"
        fill={`url(#${gradB})`}
      />
      <defs>
        <linearGradient
...
function RevelLogo({ size = 16, title }: { size?: number; title?: string }): React.ReactElement {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
      role="img"
      aria-label={title || 'Revel'}
    >
      {title ? <title>{title}</title> : null}
      <path
        d="M1.06641 8.66967C1.06641 5.44856 3.67763 2.83734 6.89874 2.83734C10.1198 2.83734 12.7311 5.44856 12.7311 8.66967C12.7311 11.8908 10.1198 14.502 6.89874 14.502C3.67763 14.502 1.06641 11.8908 1.06641 8.66967Z"
        fill="#735CFF"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M3.98257 7.33038C3.98257 10.1571 6.27405 12.4485 9.10074 12.4485C11.9274 12.4485 14.2189 10.1571 14.2189 7.33038C14.2189 4.50369 11.9274 2.21221 9.10074 2.21221C6.27405 2.21221 3.98257 4.50369 3.98257 7.33038ZM9.10074 1.49805C5.87963 1.49805 3.26841 4.10927 3.26841 7.33038C3.26841 10.5515 5.87963 13.1627 9.10074 13.1627C12.3218 13.1627 14.9331 10.5515 14.9331 7.33038C14.9331 4.10927 12.3218 1.49805 9.10074 1.49805Z"
        fill="#C7BBFF"
      />
    </svg>
  );
...
function CLILogo({ size = 16, title }: { size?: number; title?: string }): React.ReactElement {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
      role="img"
      aria-label={title || 'Redocly CLI'}
    >
      {title ? <title>{title}</title> : null}
      <rect width="16" height="16" rx="2" fill="#2467F2" />
      <path
        d="M11.6081 5.90831C11.6081 7.56846 10.2617 8.91428 8.60083 8.91428H3.68652V8.62101C5.18535 8.62101 6.40039 7.4065 6.40039 5.90831C6.40039 4.41013 5.18535 3.19561 3.68652 3.19561V2.90234H8.60083C10.2617 2.90234 11.6081 4.24816 11.6081 5.90831Z"
        fill="white"
      />
      <path
        d="M11.6081 13.02C11.6081 11.3598 10.2617 10.014 8.60083 10.014H3.68652V10.3073C5.18535 10.3073 6.40039 11.5218 6.40039 13.02H11.6081Z"
        fill="white"
      />
    </svg>
  );
...
export function LogosIcons({
  product,
  size = 16,
  className,
  title,
}: LogosIconsProps): React.ReactElement | null {
  const normalized =
    typeof product === 'string' ? product.toLowerCase() : String(product).toLowerCase();
