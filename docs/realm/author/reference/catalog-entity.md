...
The following example configures custom metadata properties for a service entity.
...
The following example configures a service entity with team ownership and domain association.
...
The following example configures a domain for organizing payment-related entities.
...
The following example configures a team with member relationships and service ownership.
...
The following example configures a user entity with email and team membership.
...
The following example configures an `api-description` entity with OpenAPI description metadata.
```yaml {% title="payments-api.entity.yaml" %}
...
The following example configures two service entities in one file.
...
- See the [catalog configuration reference](../../config/entities-catalog.md) for display and filtering options.
