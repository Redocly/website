...
While a project is in draft mode, its deployment URLs are protected behind a login screen so you can safely review your work before sharing it.

When you are ready to make the project behave like a standard live project:

1. Click **Go Live** in the editor banner.
1. Confirm the action to start a new production build and remove draft protection.

To keep your project limited to specific users after you go live, configure [RBAC](../config/access/rbac.md) before you click **Go Live**.
