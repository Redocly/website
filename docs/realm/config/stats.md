...
Statistics tell you how much content a project holds.
They show how many pages it builds, how many files of each type it contains, and how large each API description is.
...
- On the project statistics page, at `/redocly/project/stats`.
  The page is excluded from the sidebar, only signed-in users can open it, and it does not count toward the billed pages of the project.
...
- string
- **REQUIRED.**
  Path to the OpenAPI description file, relative to the configuration file.
