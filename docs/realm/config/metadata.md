...
- **[Catalog classic](./catalog-classic.md)** - Configure classic catalog that uses metadata for filtering and organization of API documentation
- **[Scorecard](./scorecard-classic.md)** - Configure classic scorecard that uses metadata for targeting specific content and quality assessment
