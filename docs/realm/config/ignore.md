...
- **[Ignore static folders and files](../customization/static-assets.md#ignore-static-folders-and-files)** - Configure which static assets and folders to exclude from your documentation build process
