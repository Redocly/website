...
- **[Classic scorecard configuration](./scorecard-classic.md)** - Configure the classic version of scorecard that uses metadata patterns for targeted content assessment and quality tracking