...
- List the URLs used to download the API description in JSON or YAML format. **Supported in Redoc CE.**
...
- number
- Sets the number of levels to display in generated payload samples. **Supported in Redoc CE.**
