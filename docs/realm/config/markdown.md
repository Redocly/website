...
- [string]
- Front matter keys whose `page` references resolve to links at build time.
  Realm always resolves `image`, `links`, `navbar`, `footer`, and `breadcrumbs`; keys you list here are added to that set.
