...
Make sure Docs MCP option is enabled in your config. After adding the option to the config file, the Docs is registered at your root URL under the `/mcp` path. For example: `https://example.com/mcp`.
