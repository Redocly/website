...
- [Gateway MCP server](./gateway-mcp/index.md) - Exposes OpenAPI definitions and enables AI assistants to make authenticated API requests

## Next steps

- Explore [Catalog MCP server](./catalog-mcp/index.md) features
- Learn about [Gateway MCP server](./gateway-mcp/index.md) capabilities
