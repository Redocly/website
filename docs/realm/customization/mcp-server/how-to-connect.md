...
- Gateway MCP Servers are registered for each API documentation and is available under the same URL as your API Reference + `/mcp` (F.e. `https://example.com/apis/museum-api/mcp`)
...
{% admonition type="success" %}
  Now you can simply pass your MCP server URL to inspector UI, list available tools and start using them.
{% /admonition %}
  {% /tab %}
{% /tabs %}
