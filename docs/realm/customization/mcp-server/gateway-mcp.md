...
Use the Gateway MCP server to interact with your APIs directly.
The server generates tools so AI assistants can make API requests based on natural language instructions.
