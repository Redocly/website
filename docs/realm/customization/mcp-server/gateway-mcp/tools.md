...
The Gateway MCP server automatically generates tools based on your OpenAPI definitions. This page explains how tools are generated and how to use them effectively.
