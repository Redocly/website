...
You can also use team mapping to assign users in your IdP groups different [project's RBAC teams](../config/access/rbac.md#team-to-role-map) or [organization roles](../access/roles.md#reserved-organization-role-names) than the default team and role.
