...
To avoid having the multiples of the same route to different resources, the build process appends a number (`-n`) to each path.
...
{% admonition type="info" title="Static files impact on your project" %}
