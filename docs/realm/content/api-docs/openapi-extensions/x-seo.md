...
When a field is omitted, `title` falls back to the operation `summary`. `description` falls back to the operation `description`, or to the operation `summary` if the operation has no `description`.
