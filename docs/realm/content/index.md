...
{% card title="Markdown content" icon="markdown" to="./reuse-content.md" %}
Write and reuse Markdown content across your project with partials, variables, and content references.
{% /card %}
...
{% card title="Static assets" icon="image" to="./static-assets.md" %}
...
{% card title="Redirects" icon="arrow-right" to="./add-redirects.md" %}
...
2. **Add your content** - Start with [Markdown pages](./reuse-content.md) or [API documentation](./api-docs/add-openapi-docs.md)
...
- Configure [content versions](./versions-config.md) for your documentation releases
