...
- Explore OpenAPI configuration options to [exclude a specific API](../../config/openapi/index.md#exclude-an-api-from-search) or [all APIs from Realm's internal search](../../config/openapi/index.md#exclude-all-apis-from-search).
