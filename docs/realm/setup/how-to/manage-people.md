...
If your documentation requires login to view, you can invite viewers to your organization. Viewers have read-only access projects and don't count as paid seats.
...
6. (Optional) Add a **Custom Message** that will be shown in the invitation email.
7. Click **Send invite**.
