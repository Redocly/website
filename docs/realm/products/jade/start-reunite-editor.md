...
{% img
  src="../../get-started/images/webview-preview.png"
...
3. Click the **Preview** button in the top right corner of the page.
   ...
   {% img
    src="../../get-started/images/view-preview-branch.png"
...
1. Click the **+** icon in the top right corner of the file tree in your editor.
   ...
   {% img
    src="../../get-started/images/add-new-file.png"
...
{% img
  src="../../get-started/images/word-wrap.png"
...
{% img
  src="../../get-started/images/slide-drawer-icon.png"
...
<summary>Download a sample logo image</summary>
  ...
  {% img
    src="../../get-started/images/logo.png"
    alt="Redocly logo"
    withLightbox=true
  /%}
</details>
...
2. Copy and paste the following configuration into the file using the editor:
   ...
   logo:
     image: ../../get-started/images/logo.png
     link: /
   ```
...
1. Click the **+** icon in the top right corner of the file tree.
   ...
   {% img
    src="../../get-started/images/add-new-folder.png"
    alt="Screenshot of the plus icon selected and displaying the dropdown menu"
    withLightbox=true
   /%}
2. Select **New folder**.
...
{% img
  src="../../get-started/images/color-picker.png"
