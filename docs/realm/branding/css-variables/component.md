...
--data-table-header-sort-indicator-gap: var(--spacing-xxs);
--data-table-header-sort-indicator-margin-top: var(--spacing-xxs);
--data-table-header-sort-indicator-margin-left: var(--spacing-xs);
--data-table-header-sort-arrow-width: 14px;
--data-table-header-sort-arrow-height: 9px;
--data-table-header-sort-arrow-border-radius: var(--border-radius);
--data-table-header-sort-arrow-bg-active: var(--bg-color-active);
--data-table-header-title-line-height: 1.4;

--data-table-score-icon-size: 16px;

--data-table-title-cell-gap: var(--spacing-sm);
--data-table-entity-title-content-offset: 42px;
--data-table-entity-title-font-size: var(--font-size-lg);
--data-table-entity-title-line-height: var(--line-height-lg);
--data-table-entity-title-font-weight: var(--font-weight-medium);
--data-table-entity-summary-font-size: var(--font-size-sm);
--data-table-entity-summary-line-height: var(--line-height-sm);
...
--entity-table-entity-title-content-offset: 42px;
...
<details>
<summary>PageDescription common variables</summary>
