...
Redocly records an event every time someone changes access, membership, or content.
...
- Subscription
- `com.redocly.subscription.updated`, `com.redocly.subscription.churned`, `com.redocly.subscription.reactivated`, `com.redocly.subscription.trialEnded`
...
The console opens on **Mock server**, which returns example data instead of your audit log.
