...
For projects in [draft mode](./project/draft-projects.md), deployment URLs are protected behind a login screen. Users must sign in before they can view the published project.
{% /admonition %}
