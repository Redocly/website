...
- A file tree pane where you can view all files included in your project, even remote and static files. You can collapse this pane to give the editor more space.
