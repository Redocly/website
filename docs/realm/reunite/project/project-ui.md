...
To keep a file open, double-click its tab or start editing the file—this converts the preview tab into a regular tab.

### Utility tabs

Two utility tabs can be opened in the editor dock:
