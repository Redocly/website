...
Remote content folders and files are synced one way, so any updates pushed to your online Git repository are reflected in the Redocly project and can be deployed and published through Redocly.
