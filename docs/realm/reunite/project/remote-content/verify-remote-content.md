...
3. A pull request from `rem/git/rem_012345` to the default branch is created (see [Automatically-created pull requests](#automatically-created-pull-requests)).
4. A preview build for `rem/git/rem_012345` branch is created to verify that changes do not break the project.
