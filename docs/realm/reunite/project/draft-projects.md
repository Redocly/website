...
<!-- Screenshot from Figma https://www.figma.com/design/Zliu5FEE44XSxM9Fmk8dXj/Documentation?node-id=3-3140&t=izL1sCPkCipuRpwt-4() -->
{% img
...
Each deployment created while the project is in draft mode is permanently labeled with a **Draft** badge.
...
2. In the editor banner, click **Go Live**.
<!-- Screenshot from Figma https://www.figma.com/design/Zliu5FEE44XSxM9Fmk8dXj/Documentation?node-id=3-3140&t=izL1sCPkCipuRpwt-4() -->
{% img
