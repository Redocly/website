...
You can connect a repository when you [create a project](../create-project/index.md#create-a-project-from-an-existing-repository), or later in the project's **Settings > Git hosting** page.
