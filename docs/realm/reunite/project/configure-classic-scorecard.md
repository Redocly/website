...
## Configure custom rulesets for classic socrecard
...
### Configure rulesets fir classic scorecard in separate files
...
- **[Scorecard feature overview](./reunite-scorecard.md)** - Understand what scorecards display, how to access reports, and their role in API quality management
