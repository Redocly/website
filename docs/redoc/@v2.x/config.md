...
If you are use Redoc as a standalone (HTML or React) tool, provide the options on these page in kebab case.
...
The following options are deprecated from Redoc v2.x onwards.
...
- **[Use Redocly CLI with Redoc](./deployment/cli.md)** - Deploy API documentation using Redoc and Redocly CLI
...
- **[Redoc vendor extensions](./redoc-vendor-extensions.md)** - Configure specification extensions in Redoc
