...
Redoc is highly configurable - see the [full list of configuration options](https://redocly.com/docs/realm/config/openapi).
...
Redoc uses [CSS variables](https://redocly.com/docs/realm/branding/css-variables) under the hood.
To customize your API documentation's appearance, override these variables.

The following example transforms Redoc CE default styling to be like the previous versions of Redoc:
...
As an alternative to the HTML tag, you can also initialize Redoc in a web page using the Redoc object and invoking it from JavaScript.
