...
The following table shows the changes in configuration options between Redoc 2.x and the newest Redoc 3.x configuration.
...
- **[Configure Redoc](./config.md)** - See configuration options for Redoc 3.x
